function(user_configure_frontend project_root binary_dir)
    set(embed_script "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/generate_embed.cmake")
    ...
    add_custom_target(user_generate_embed ALL
        COMMAND "${CMAKE_COMMAND}"
            -DOUTPUT_HEADER=${embed_header}
            -DINPUT_BOOTSTRAP=${bootstrap_lua}
            -DINPUT_SB_PROFILE=${sb_profile}
            -P ${embed_script}
